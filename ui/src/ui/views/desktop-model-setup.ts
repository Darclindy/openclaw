    ...
    return html`
      <label class="field full">
        ...
        <input
          ...
          autocomplete="off"
          spellcheck="false"
          .value=${typeof state.desktopWizardAnswer === "string"
            ? state.desktopWizardAnswer
            : ""}
    ...
    return html`
      <label class="field full">
        ...
        >
          ${(step.options ?? []).map(
            (option) => html`
              <option value=${String(option.value)} ?selected=${option.value === state.desktopWizardAnswer}>
                ${option.label}
              </option>
            `,
          )}
...
export function renderDesktopModelSetup(state: AppViewState) {
  ...
  const preset = DESKTOP_MODEL_SETUP_PRESETS.find((entry) => entry.id === form.preset) ??
        ...
        <div class="desktop-model-setup__status">
          ...
          <div>
            ...
            ${state.desktopWizardError
              ...
              : nothing}
            ${state.desktopWizardDone ? html`<div class="callout success">Setup wizard completed.</div>` : nothing}
            ...
            <div class="desktop-model-setup__actions">
              ...
              >
                ${state.desktopWizardBusy ? icons.loader : icons.settings}
                Start wizard
              </button>
        ...
        <div class="desktop-model-setup__status">
          ...
          <div>
            ...
            <div class="desktop-model-setup__actions">
              ...
              >
                ${state.desktopCliLoading ? icons.loader : icons.refresh}
                Check CLI
              </button>
              <button
                class="btn"
              ...
              >
                ${state.desktopCliInstalling ? icons.loader : icons.download}
                Install CLI
              </button>
            </div>
          </div>
        ...
        <div class="desktop-model-setup__status">
          ...
          <div>
            ...
            <div class="desktop-model-setup__actions">
              ...
              >
                ${state.desktopNotificationLoading ? icons.loader : icons.check}
